  ...
  (testing "monthly-window should successfully calculate salary over two years."
    (is (= (monthly-window salaries-timetable bonuses-timetable (t/date-time 2017 1) 13) 
           [[[2017 1] {:base-salary 12000, :bonus 1200, :total 13200, :total-per-month 1100, :months 12, :effective-salary-for-year 13200}] 
            ...
            [[2018 1] {:base-salary 24000, :bonus 2400, :total 26400, :total-per-month 2200, :months 12, :effective-salary-for-year 26400}]] 
            )))
            ...
            (testing "year-stats for january 2018"
              (is (= (year-stats salaries-timetable bonuses-timetable (t/date-time 2018 1)) {:base-salary 24000, :bonus 2400, :total 26400, :total-per-month 2200, :months 12, :effective-salary-for-year 26400} ))
              )
            ...
            (testing "bonus excluded when query start-date equals bonus end-date"
              (is (= (effective-bonus 12000 (t/date-time 2018 1) (t/date-time 2019 1) (t/date-time 2019 1) (t/date-time 2019 2)) 0))
              )
            )
